...
![lofence](https://github.com/kiu/lofence/pics/lofence_revb_final_thumb.jpg)
...
Checking their [coverage map](https://www.thethingsnetwork.org/map) of course showed that the area of interest has no gateways in reach, but setting up a simple [gateway](https://github.com/kiu/lofence/pics/lofence_ttig.jpg) - in our case a [TTIG](https://www.thethingsnetwork.org/forum/t/ttig-the-things-indoor-gateway/22049) for ~80 Euro - easily solved the coverage problem. According to their [Fair Access Policy](https://www.thethingsnetwork.org/forum/t/limitations-data-rate-packet-size-30-seconds-uplink-and-10-messages-downlink-per-day-fair-access-policy/1300) our use-case of sending a few bytes of measurement data every few hours is perfectly fitted for their service. Let’s roll.
